...
import com.example.recyclick.databinding.FragmentTambahKaryawanBinding;
...
public class TambahKaryawanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentTambahKaryawanBinding fragmentTambahKaryawanBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_tambah_karyawan,container,false);
        fragmentTambahKaryawanBinding.txtKembali.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        return fragmentTambahKaryawanBinding.getRoot();
    }
}